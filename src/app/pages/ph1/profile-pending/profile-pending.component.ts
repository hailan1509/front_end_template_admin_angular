...
@Component({
  selector: 'app-profile-pending',
  templateUrl: './profile-pending.component.html',
  styleUrls: ['./profile-pending.component.scss'],
})
export class ProfilePendingComponent implements OnInit {
