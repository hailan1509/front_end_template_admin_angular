...
import { Item, Role } from 'src/app/@core/data/listData';
import { ListDataService } from 'src/app/@core/mock/list-data.service';
import { FormConfig } from 'src/app/@shared/components/admin-form';

@Component({
  selector: 'app-role-ref',
  templateUrl: './role-ref.component.html',
  styleUrls: ['./role-ref.component.scss']
})
export class RoleRefComponent implements OnInit {

  filterRoleShow = false;
  ...
  getList() {
    this.api.post("api/manager/RoleRef/Search",{page : this.pager.pageIndex , pageSize: this.pager.pageSize , role_name_l : this._search.keyword}).subscribe((res:any) => {
      ...
      buttons: [
        {
          ...
          disabled: false,
          handler: ($event: Event) => {
            this.api.post("api/manager/RoleRef/DeleteMulti",[id]).subscribe((res:any) => {
  ...
  onSubmitted(e: any) {
    ...
    if (this.insert) {
      e.role_rcd=e.role_rcd;
      e.role_code=e.role_code;
      e.role_name_e = e.role_name_e;
      e.role_name_l = e.role_name_l;
