...
import { Item, AgencyIssued } from 'src/app/@core/data/listData';
import { ListDataService } from 'src/app/@core/mock/list-data.service';
import { FormConfig } from 'src/app/@shared/components/admin-form';

@Component({
  selector: 'app-agency-issued-ref',
  templateUrl: './agency-issued-ref.component.html',
  styleUrls: ['./agency-issued-ref.component.scss']
})
export class AgencyIssuedRefComponent implements OnInit {

  filterAgencyIssuedShow = false;
  ...
  newAgencyIssued  = {
    ...
    agency_issued_name_e: "",
    agency_issued_name_l: "", 
    sort_order: 1,
    agency_issued_note_e: "",
    agency_issued_note_l: "",
    active_flag: 0,
    created_by_user_id: "",
    created_date_time: "",
    lu_user_id: "",
  ...
  addRow() {
    this.insert = true;
    this.formData = this.newAgencyIssued;
    this.editForm = this.dialogService.open({
      id: 'edit-dialog',
      width: '600px',
      maxHeight: '600px',
      title: 'Thêm cơ quan ban hành',
      showAnimate: false,
      contentTemplate: this.EditorTemplate,
      backdropCloseable: true,
      onClose: () => {},
      ...
      buttons: [
        {
          ...
          disabled: false,
          handler: ($event: Event) => {
            this.api.post("api/manager/AgencyIssuedRef/DeleteMulti",[id]).subscribe((res:any) => {
  ...
  onSubmitted(e: any) {
    ...
    if (this.insert) {
      const obj = {
        agency_issued_rcd:e.agency_issued_rcd,
        agency_issued_name_e : '',
        agency_issued_name_l : e.agency_issued_name_l,
        agency_issued_note_e : '',
        agency_issued_note_l : e.agency_issued_note_l,
